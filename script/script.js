...
movies.forEach((movie, index) => {
  ...
  content.innerHTML += `
  <a href="${window.location.origin}/film.html?index=${index}"> 
    <div class="contentMovie">

		<div class="contentMovie__image">
			<img src=${movie.coverimage} height="200" with="auto" alt=""/>
		</div>
...
searchBar.addEventListener("input", filterTitleMovies);
...
function filterYearMovies() {
  ...
  const filterYearRange = document.querySelector("#filterYearRange");
